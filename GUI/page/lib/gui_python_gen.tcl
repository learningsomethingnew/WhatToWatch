...
proc vTcl:run_prep {prefix {save "save"}} {
    ...
    # Test to see if support module needs updates.cp
    set window $vTcl(tops)
...
$vTcl(tab2)$vTcl(tab)self.$widname.bind('<Button-2>', $cmd)
$vTcl(tab2)$vTcl(tab)self.$widname.bind('<Control-1>', $cmd)
$vTcl(tab2)else:
$vTcl(tab2)$vTcl(tab)self.$widname.bind('<Button-3>', $cmd)
"
return $result
}
