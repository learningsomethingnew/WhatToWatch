#############################################################################
# Generated by PAGE version 4.7a
...
proc vTclWindow.top34 {base} {
    ...
    button $top.but37 \
        -activebackground {#f4bcb2} -background wheat -command quit \
        -disabledforeground {#b8a786} -font font10 -foreground {#000000} \
        -highlightbackground wheat -highlightcolor black -text Quit 
    vTcl:DefineAlias "$top.but37" "Button3" vTcl:WidgetProc "parms" 1
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.but34 \
    ...
    place $top.but35 \
        -in $top -x 120 -y 350 -anchor nw -bordermode ignore 
    place $top.lab36 \
        -in $top -x 210 -y 220 -width 273 -height 27 -anchor nw \
        -bordermode ignore 
    place $top.but37 \
        -in $top -x 400 -y 350 -anchor nw -bordermode ignore 
